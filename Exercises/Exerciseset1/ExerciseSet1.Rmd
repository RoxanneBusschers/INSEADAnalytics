...
2. I get an error, because StockReturns only has two columns (the first one contains both the dae and the returns) and myData has 3 columns (first with a date and second two with the returns).
